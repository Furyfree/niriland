...
Niri. The active installer still deploys DankMaterialShell; the earlier
Noctalia rewrite is deferred. It is intentionally opinionated and fresh-install
...
- Keep legacy config links and updater wrappers until existing installs no
  longer use them; directory moves alone do not update deployed copies.
