...
Development has ended in favor of [Nimbus](https://github.com/Furyfree/nimbus).
`main` presents the pre-rewrite installation, with machine-local editor state
excluded and the sanitized Minecraft pack retained.

- [`v1`](https://github.com/Furyfree/niriland/tree/v1): last pre-rewrite
  installation snapshot, `1b3c74c` (22 August 2026).
- [`v2`](https://github.com/Furyfree/niriland/tree/v2): unfinished rewrite,
  `091a89a` (10 September 2026). Its apply/update/postinstall phases were not
  completed before work moved to Nimbus.

This is a historical installer, not revalidated against current CachyOS.
It retains legacy password handling and TPM setup; inspect those steps before
using it. The installation has not been run as part of this restoration.
