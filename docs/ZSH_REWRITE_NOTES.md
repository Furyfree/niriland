...
configs/home/.config/zsh/.zshenv
configs/home/.config/zsh/.zprofile
configs/home/.config/zsh/.zshrc
configs/home/.config/zsh/aliases.zsh
configs/home/.config/zsh/bindings.zsh
configs/home/.config/zsh/completion.zsh
configs/home/.config/zsh/env.zsh
configs/home/.config/zsh/fzf.zsh
configs/home/.config/zsh/functions.zsh
configs/home/.config/zsh/history.zsh
configs/home/.config/zsh/path.zsh
configs/home/.config/zsh/plugins.zsh
configs/home/.config/zsh/prompt.zsh
configs/home/.config/zsh/zoxide.zsh
configs/home/.config/zsh/starship.toml
configs/home/.config/zsh/.gitignore
```

Existing Sheldon config can stay here for now:

```text
configs/home/.config/sheldon/plugins.toml
```
...
Do not deploy `configs/home/.zshenv` in the final version.
...
This replaces the current behavior where `installer/steps/50-setup-tools`
appends to `~/.zprofile`.
...
```text
configs/home/.config/zsh/options.zsh
```
...
Inside Niriland's `configs/home/.config/zsh`, this may be less useful because
...
```text
configs/home/.zshrc
configs/shared/.config/zsh/*
installer/steps/50-setup-tools
bin/niriland-setup-flutter
installer/steps/40-setup-shell
```
...
- Stop using `~/.local/share/niriland/configs/shared/.config/zsh` as runtime config.
...
1. Add the new files under `configs/home/.config/zsh`.
...
8. After testing, remove or deprecate old `configs/shared/.config/zsh`.
